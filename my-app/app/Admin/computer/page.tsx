          ...
          <TableHeader>
            <TableRow className="h-14">
              ...
              <TableHead className="text-end" colSpan={20}>
                <Button className="bg-blue-700 hover:bg-blue-600 active:bg-blue-500">+ Add New Computer</Button>
              </TableHead>
            </TableRow>
            <TableRow className="py-4 bg-gray-50">
              <TableHead className="font-semibold">Computer Name</TableHead>
              <TableHead className="font-semibold">Computer Version</TableHead>
              <TableHead className="font-semibold">OS Version</TableHead>
              <TableHead className="text-right font-semibold">CPU</TableHead>
