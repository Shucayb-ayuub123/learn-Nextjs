      ...
      >
        <SafeAreaView className="flex-1 justify-center items-center space-y-11">
          ...
          <TextInput
            ...
            value={password}
          />
          <Pressable className="bg-slate-400 mt-9 text-center w-8/12 h-14 p-2 rounded-md"  onPress={handleSubmit}>
            <Text
              className="text-red-500 text-center  w-full font-semibold text-3xl "
